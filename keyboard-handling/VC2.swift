...
class VC2: UIViewController {
    ...
    lazy var keyboardHandler = KeyboardHandler2(controller: self)
    
    override func viewDidLoad() {
        super.viewDidLoad()
        navigationItem.title = "TableView+KeyboardHandler2"
...
extension VC2: UITextFieldDelegate, UITextViewDelegate {
